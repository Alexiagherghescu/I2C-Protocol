...
(    
    ...
    input  logic [6:0] addr_slave,
    input  logic [6:0] addr_reg,
    output logic scl,
    output logic rw, 
    inout  wire  sda  
);
        ...
        case (state)
            ...
            TX_SLAVE_ADDR_W: begin
                ...
                case (q_tick)
                    ...
                    2'd1: begin scl <= 1'b0; sda_out <= shift_reg[bit_count]; end 
            ...
            TX_ACK: begin
                ...
                case (q_tick)
                    2'd0: begin scl <= 1'b0; end 
                    2'd1: begin scl <= 1'b0; sda_out <= 1'b0; end 
                    2'd2: begin scl <= 1'b1; end 
                    2'd3: begin scl <= 1'b1; end 
                endcase 
            ...
            RX_DATA_BYTE_LSB: begin
                sda_en <= 1'b0;
                case (q_tick)
                    2'd0: begin scl <= 1'b0; end 
                    2'd1: begin scl <= 1'b0; end 
                    2'd2: begin scl <= 1'b1; 
                    shift_reg[bit_count] <= sda; end
                    2'd3: begin scl <= 1'b1; end 
                endcase
