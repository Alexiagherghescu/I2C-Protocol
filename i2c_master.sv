    ...
    if (reset) begin
        ...
        case (state)
            ...
            TX_SLAVE_ADDR_W: begin
                sda_en <= 1'b1;
                case (q_tick)
                    2'd0 : begin scl <= 1'b0; sda_out <= shift_reg[bit_count]; end 
            ...
            TX_SLAVE_ADDR_R: begin
                sda_en <= 1'b1;
                case (q_tick)
                    2'd0, 2'd1: begin scl <= 1'b0; sda_out <= shift_reg[bit_count]; end 
                    2'd2, 2'd3: begin scl <= 1'b1; end 
                endcase
            ...
            TX_NACK: begin
                ...
                case (q_tick)
                    2'd0: begin scl <= 1'b0; sda_out <= 1'b1; end 
                    2'd1: begin scl <= 1'b0; sda_out <= 1'b1; end 
                    2'd2: begin scl <= 1'b1; end 
                    2'd3: begin scl <= 1'b1; end 
                endcase
            ...
            STOP_COND: begin
                ...
                case (q_tick)
                    ...
                    2'd2:  begin scl <= 1'b1; sda_out <= 1'b1; end 
                     2'd3: begin scl <= 1'b1; sda_out <= 1'b1; end 
                endcase
